...
java --module-path <CHEMIN_VERS_JAVAFX_SDK>/lib --add-modules javafx.controls,javafx.fxml -jar reseau-electrique.jar instance1.txt 30

Exemple (macOS) :

java --module-path ~/javafx/javafx-sdk-17.0.17/lib --add-modules javafx.controls,javafx.fxml -jar reseau-electrique.jar instance1.txt 30

--------------------------------------------------
9. COMPILATION ET EXÉCUTION DEPUIS SRC
--------------------------------------------------
- Windows :

javac ^
--module-path "<CHEMIN_VERS_JAVAFX_SDK>/lib" ^
--add-modules javafx.controls,javafx.fxml ^
-d bin ^
src\main\java\up\mi\paa\reseau_electrique\*.java ^
src\main\java\up\mi\paa\reseau_electrique\controller\*.java ^
src\main\java\up\mi\paa\reseau_electrique\model\*.java ^
src\main\java\up\mi\paa\reseau_electrique\view\*.java

java ^
--module-path "<CHEMIN_VERS_JAVAFX_SDK>/lib" ^
--add-modules javafx.controls,javafx.fxml ^
-cp bin ^
up.mi.paa.reseau_electrique.Main


- Linux/macOS :

JAVAFX="<CHEMIN_VERS_JAVAFX_SDK>/lib"
...
ava --module-path "$JAVAFX" \
--add-modules javafx.controls,javafx.fxml \
-cp bin \
up.mi.paa.reseau_electrique.Main instance1.txt 30


--------------------------------------------------
10. UTILISATION – INTERFACE CONSOLE
--------------------------------------------------
...
--------------------------------------------------
11. FORMAT DES FICHIERS (PARTIE 2)
--------------------------------------------------
...
Si Maven est installé il est possible d'exécuter tous les tests unitaires avec : mvn test
